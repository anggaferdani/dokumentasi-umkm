  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        ...
        <li class="nav-item {{ Route::is('admin.shelter.*', 'admin.shelter.booth.*') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.shelter.*', 'admin.shelter.booth.*') ? 'fw-bold' : '' }}" href="{{ route('admin.shelter.index') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-layer-group"></i></span><span class="nav-link-title">Shelter</span></a></li>
        <li class="nav-item {{ Route::is('admin.umkm.*') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.umkm.*') ? 'fw-bold' : '' }}" href="{{ route('admin.umkm.index') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-user"></i></span><span class="nav-link-title">UMKM</span></a></li>
